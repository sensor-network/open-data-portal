import toSQL from "~/lib/utils/iso-to-sql-timestamp";
...
it("should accept variations of it", () => {
  ...
  expect(toSQL("2022-01-01:12:00:00.000-5")).toEqual("2022-01-01T17:00:00.000");
  expect(toSQL("2022-01-01:12:00:00.000-05")).toEqual(
    "2022-01-01T17:00:00.000"
  );
  expect(toSQL("2022-01-01 12:00:00.000-0500")).toEqual(
    "2022-01-01T17:00:00.000"
  );
});
